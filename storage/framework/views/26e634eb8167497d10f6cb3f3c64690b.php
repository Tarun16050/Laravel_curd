    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><strong>Department:</strong> <?php echo e($data->department); ?></li>
            </ul>
            <div class="mt-3">
                <a href="<?php echo e(route('employeeData')); ?>" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\wamp64\www\laravelCURD\resources\views/EmployeeForm/view.blade.php ENDPATH**/ ?>